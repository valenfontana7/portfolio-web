...
export default function ProjectCard({ p }) {
  ...
  return (
    <li className="project-card reveal" data-project={p.id} data-animate="fade-up">
      {p.highlight ? <span className="project-card__badge">Destacado</span> : null}
      ...
      <div className="project-card__overlay" tabIndex="0" aria-hidden="true">
        <div className="project-card__overlayInner">
          <button
            data-open={p.site}
          ...
          >
            ...
            <span className="visually-hidden">Visitar {p.title}</span>
          </button>
